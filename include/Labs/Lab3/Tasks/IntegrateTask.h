...
class IntegrateTask {
public:
    explicit IntegrateTask(IIntegralSolver& integrator, Plotter* plotter = nullptr, unsigned short graph_num = 1)
            : integrator(integrator), plotter(plotter), graphNumber(graph_num) {}
