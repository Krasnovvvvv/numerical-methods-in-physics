...
4. [Заключение и выводы 📝](#заключение-и-выводы-)
...
![Трапеции гамма](../images/Lab3/TrapezoidsError.png)
...
Главная сложность — интегрирование на неограниченном интервале (от 0 до бесконечности), а также наличие выражений $ln(x)$ и осциллирующей $sin(x)$, что приводит к медленной сходимости ошибки на обычных равномерных сетках. Для корректного применения метода была выполненf замена $x = t / (1 - t); t ∈ [0, 1)$
