...
![Аисмптотика метода прогонки](../images/Lab1/ThomasMethod.png)
**График 1 - Проверка линейной асимптотики метода прогонки**


![Метод Якоби](../images/Lab1/JacobiMethod.png)
**График 2 - Сходимость метода Якоби**


![Метод Зейделя](../images/Lab1/SeidelMethod.png)
**График 3 - Сходимость метода Зейделя**


![Метод верхней релаксации](../images/Lab1/SORMethod.png)
**График 4 - Сходимость метода SOR**


![Метод градиентного спуска](../images/Lab1/GradientDescentMethod.png)
**График 5 - Сходимость метода найскорейшего спуска**


![Метод сопряжённых градиентов](../images/Lab1/ConjugateGradientsMethod.png)
**График 6 - Сходимость метода сопряжённых градиентов**


![Метод сопряжённых градиентов, расходимость](../images/Lab1/ConjugateGradientsBadResult.png)
**График 7 - Расходимость метода сопряжённых градиентов для плохо обусловленной задачи**


![Оптимальный параметр SOR](../images/Lab1/OptimalParam.png)
**График 8 - Поиск оптимального значения параметра для метода SOR**


![Оптимальный параметр SOR от погрешности](../images/Lab1/OptimalParam_10-4.png)
**График 9 - Проверка зависимости оптимального параметра от точности**


![Оптимальный параметр SOR от размера](../images/Lab1/OptimalParam_n50.png)
