...
На графике решения при 10 узлах исленное решение методом Гаусса–Кристоффеля практически полностью совпадает с точным: кривые визуально сливаются на всём интервале, а ошибка остаётся на уровне  $10^{-3}$ и монотонно растёт к правому краю.
